...
require("dotenv").config(); // it is enough to put this on the main page instead of calling it in other files whenever you want to call something frm the env
...
app.use(verifyJwt); //order matters a lot cus the server excute as waterfall from top to bottom so any ruote under this middleware is going to be checked with this middleware first
...
mongoose.connection.once("open", () => {
  // this will listen to the event once, open equivilent to connect
